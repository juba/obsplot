...
data(barley)
# precompute domains
y_domain <- levels(reorder(barley$variety, barley$yield, median))
fy_domain <- levels(reorder(barley$site, barley$yield, median))
...
obsplot(barley, height = 800) |>
    ...
    scale_x(nice = TRUE) |>
    scale_y(domain = y_domain, reverse = TRUE, inset = 5) |>
    scale_fy(domain = fy_domain, reverse = TRUE) |>
